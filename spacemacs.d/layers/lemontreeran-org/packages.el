;;; packages.el --- lemontreeran-org layer packages file for Spacemacs.
;;
;; Copyright (c) 2012-2017 Sylvain Benner & Contributors
;;
;; Author: Lemontreeran <lemontreeran@Lemontreeran.local>
...
;; added to `lemontreeran-org-packages'. Then, for each package PACKAGE:
;;
;; - If PACKAGE is not referenced by any other Spacemacs layer, define a
;;   function `lemontreeran-org/init-PACKAGE' to load and initialize the package.

;; - Otherwise, PACKAGE is already referenced by another Spacemacs layer, so
;;   define the functions `lemontreeran-org/pre-init-PACKAGE' and/or
;;   `lemontreeran-org/post-init-PACKAGE' to customize the package as it is loaded.
...
(defun lemontreeran-org/post-init-org ()
...
;; Setup org-reveal for presentations
 ;; (setq-default dotspacemacs-configuration-layers
 ;;              '((org :variables org-enable-reveal-js-support t)))
(defun lemontreeran-org/post-init-org-pomodoro ()
  (lemontreeran/pomodoro-notification))

(defun lemontreeran-org/post-init-deft ()
  (progn
